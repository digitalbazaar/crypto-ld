  ...
  describe('EcdsaSecp256k1VerificationKey2019', () => {
    ...
    describe('generate', () => {
      it('should generate a key pair', async () => {
        ...
        ldKeyPair.type.should.equal('EcdsaSecp256k1VerificationKey2019')
        ...
        privateKeyBytes.length.should.equal(32);
        publicKeyBytes.length.should.equal(33);
        
      });
      it.skip('should generate the same key from the same seed', async () => {
      ...
      it.skip('should fail to generate a key with an invalid seed', async () => {
        let error;
        try {
          const seed = null;
    ...
    describe('fingerprint', () => {
      it('should create an key fingerprint', async () => {
        const keyPair = await LDKeyPair.generate({type});
      ...
      it.skip('should be properly multicodec encoded', async () => {
        ...
        mcType.should.equal('secp256k1-pub');
    ...
    describe('verify fingerprint', () => {
      ...
      it.skip('generates the same fingerprint from the same seed', async () => {
        const seed = new Uint8Array(32);
        seed.fill(0x01);
        const keyPair1 = await LDKeyPair.generate({type, seed}); 
        const keyPair2 = await LDKeyPair.generate({type, seed}); 
