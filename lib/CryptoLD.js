...
class CryptoLD {
   ...
   * @param {boolean} checkContext - Whether to check that the fetched key
   *   document contains the context required by the key's crypto suite.
   * @param {boolean} checkRevoked - Whether to check the key object for
